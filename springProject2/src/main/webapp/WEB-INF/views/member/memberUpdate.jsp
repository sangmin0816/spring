            ...
            <div class="container">
                ...
                <div class="tabs is-centered">
                    <ul>
                        ...
                        <li><a href="${rootPath}/vote/getMyList">나의 투표 내역</a></li>
                        <li><a href="${rootPath}/attend/getMyAttend">나의 출석</a></li>
                    </ul>
                </div>
                <hr>
                <form action="${rootPath}/member/update" method="post" onsubmit="return updateCheck(this)">
