    ...
    <div class="container contents_area">
        ...
        <div class="container">
            ...
            <div class="buttons is-right">
                <a class="button is-mainColor" href="${rootPath}/admin/List">글 목록</a>
                <a class="button is-success" href="${rootPath}/admin/Update.do?no=${notice.no}">글 수정</a>
                <a class="button is-mainColor" href="${rootPath}/admin/Delete.do?no=${notice.no}">글 삭제</a>
            </div>
        </div>
    </div>
</div>
