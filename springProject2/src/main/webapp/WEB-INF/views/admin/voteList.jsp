    ...
    <div class="container contents_area2">
        <div class="column">
            <div class="buttons is-right">
                <a href="${path}/vote/list" class="button is-mainColor">사용자 홈페이지 이동</a>
            </div>
            <h1 class="is-size-3 has-text-weight-semibold">투표</h1>
            <form action="${path }/admin/VoteMemberListAdmin" method="get" class="field has-addons has-addons-right">
                <p class="control">
                    <span class="select">
            ...
            <div class="buttons is-right">
                <a href="${path }/admin/voteAdd" class="button is-mainColor">등록</a>
            </div>
