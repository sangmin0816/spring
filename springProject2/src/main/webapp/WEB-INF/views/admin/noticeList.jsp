...
<head>
    ...
    <link rel="stylesheet" href="${rootPath}/resources/css/admin.css">
</head>
<body>
...
<div class="admin_contents_area">
    ...
    <div class="container contents_area2">
        <div class="buttons is-right">
            <a href="${rootPath}/notice/List" class="button is-mainColor">사용자 홈페이지 이동</a>
        </div>
        ...
        <div class="container">
            <table class="table">
                ...
                <c:forEach items="${noticeList }" var="notice" varStatus="status">
                    <tr>
                        ...
                        <td class="item2 has-text-centered"><a href="${rootPath}/admin/Get.do?no=${notice.no }">${notice.title }</a></td>
            ...
            <div class="buttons is-right">
                <a href="${rootPath}/admin/Insert" class="button is-mainColor">공지 등록</a>
            </div>
        </div>
    </div>
</body>
