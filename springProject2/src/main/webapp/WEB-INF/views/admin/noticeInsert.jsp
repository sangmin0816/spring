...
<div class="admin_contents_area">
    ...
    <div class="container contents_area">
        ...
        <div class="container">
            <form action="${rootPath}/admin/Insert" method="post">
            <table class="table tb2">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script>
                            CKEDITOR.replace('content',	{filebrowserUploadUrl:'${rootPath}/util/imageUpload.do'});
                        </script>
                    </td>
                </tr>
                </tbody>
                ...
                <div class="buttons is-right">
                    ...
                    <a class="button is-success" href="${rootPath}/admin/List">글 목록</a>
                </div>
            </form>
        </div>
    </div>
