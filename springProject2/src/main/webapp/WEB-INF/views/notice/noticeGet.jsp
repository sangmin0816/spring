...
<div class="content">
    ...
    <div class="viewbody">
        ...
        <div class="buttons is-centered">
            ...
            <c:if test='${sid eq "admin"}'>
                <a class="button is-success" href="${rootPath}/notice/noticeUpdate?no=${notice.no}">글 수정</a>
                <a class="button is-mainColor" href="${rootPath}/notice/noticeDelete?no=${notice.no}">글 삭제</a>
            </c:if>
        </div>
    </div>
