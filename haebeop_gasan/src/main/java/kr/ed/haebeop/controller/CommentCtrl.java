...
public class CommentCtrl {
    ...
    public String insertForm(HttpServletRequest request, Model model) throws Exception {
        return "/board/comment/commentInsert";
    }
    ...
    public String commentInsert(HttpServletRequest request, Model model) throws Exception {
        ...
        comment.setFreeNo(Integer.parseInt(request.getParameter("par")));
    ...
    public ModelAndView commentDelete(HttpServletRequest request, Model model) throws Exception {
        ...
        if(!sid.equals("admin")) {
            mav.setView(new RedirectView(request.getContextPath() + "/board/free/get"));
        } else {
