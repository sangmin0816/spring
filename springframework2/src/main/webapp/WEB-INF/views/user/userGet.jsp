            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 text-secondary">${user.addr1} ${user.addr2} (${user.postcode})</div>
                    </div>
                    <hr>

                    <div class="row">
                        <div class="col-sm-3"><h6 class="mb-0">Birth</h6></div>
                        <div class="col-sm-9 text-secondary">${user.birth}</div>
                    </div>
                    <hr>

                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-info" href="${rootPath}/user/update" style="float: right">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
